...
.method private buildTaskList()V
    ...
    .line 234
    iget-object v8, v1, Landroid/support/v7/widget/RecyclerView;->mPrefetchRegistry:Landroid/support/v7/widget/GapWorker$LayoutPrefetchRegistryImpl;

    .line 235
    iget v0, v8, Landroid/support/v7/widget/GapWorker$LayoutPrefetchRegistryImpl;->mPrefetchDx:I
    ...
    .line 237
    :goto_3
    iget v0, v8, Landroid/support/v7/widget/GapWorker$LayoutPrefetchRegistryImpl;->mCount:I
    ...
    .line 240
    new-instance v0, Landroid/support/v7/widget/GapWorker$Task;

    invoke-direct {v0}, Landroid/support/v7/widget/GapWorker$Task;-><init>()V
    ...
    :goto_5
    iput-boolean v5, v0, Landroid/support/v7/widget/GapWorker$Task;->immediate:Z

    .line 248
    iput v9, v0, Landroid/support/v7/widget/GapWorker$Task;->viewVelocity:I

    .line 249
    iput v10, v0, Landroid/support/v7/widget/GapWorker$Task;->distanceToItem:I

    .line 250
    iput-object v1, v0, Landroid/support/v7/widget/GapWorker$Task;->view:Landroid/support/v7/widget/RecyclerView;
    ...
    iput v5, v0, Landroid/support/v7/widget/GapWorker$Task;->position:I
