...
.method layoutChunk(Landroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;Landroid/support/v7/widget/LinearLayoutManager$LayoutState;Landroid/support/v7/widget/LinearLayoutManager$LayoutChunkResult;)V
    ...
    .line 579
    invoke-virtual {p0, v9}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->addView(Landroid/view/View;)V

    .line 590
    :goto_6
    iget-object v2, p0, Landroid/support/v7/widget/GridLayoutManager;->mDecorInsets:Landroid/graphics/Rect;

    invoke-virtual {p0, v9, v2}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->calculateItemDecorationsForChild(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    iget-object v13, p0, Landroid/support/v7/widget/LinearLayoutManager;->mOrientationHelper:Landroid/support/v7/widget/OrientationHelper;
    ...
    invoke-virtual {p0, v9, v2}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->addView(Landroid/view/View;I)V
    ...
    .line 585
    invoke-virtual {p0, v9}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->addDisappearingView(Landroid/view/View;)V
    ...
    invoke-virtual {p0, v9, v2}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->addDisappearingView(Landroid/view/View;I)V
    ...
    .line 633
    iget v10, p0, Landroid/support/v7/widget/LinearLayoutManager;->mOrientation:I
    ...
    invoke-direct {p0, v7, v2, v4, v8}, Landroid/support/v7/widget/GridLayoutManager;->measureChildWithDecorationsAndMargin(Landroid/view/View;IIZ)V
    ...
    .line 651
    iget v8, p0, Landroid/support/v7/widget/LinearLayoutManager;->mOrientation:I
    ...
    .line 685
    invoke-virtual/range {v6 .. v11}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->layoutDecoratedWithMargins(Landroid/view/View;IIII)V
...
.method public onFocusSearchFailed(Landroid/view/View;ILandroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;)Landroid/view/View;
    ...
    iget-boolean v5, v0, Landroid/support/v7/widget/LinearLayoutManager;->mShouldReverseLayout:Z
    ...
    iget v7, v0, Landroid/support/v7/widget/LinearLayoutManager;->mOrientation:I
    ...
    invoke-virtual {v0, v11, v1, v2}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->isViewPartiallyVisible(Landroid/view/View;ZZ)Z
...
.method public onInitializeAccessibilityNodeInfoForItem(Landroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;Landroid/view/View;Lo/ıɨ;)V
    .locals 8
    ...
    .line 147
    invoke-super {p0, p3, p4}, Landroid/support/v7/widget/LinearLayoutManager;->onInitializeAccessibilityNodeInfoForItem(Landroid/view/View;Lo/ıɨ;)V
    ...
    .line 153
    invoke-static/range {v0 .. v5}, Lo/ıɨ$If;->ˎ(IIIIZZ)Lo/ıɨ$If;

    move-result-object v0

    invoke-virtual {p4, v0}, Lo/ıɨ;->ˏ(Ljava/lang/Object;)V
    ...
    .line 158
    invoke-static/range {v2 .. v7}, Lo/ıɨ$If;->ˎ(IIIIZZ)Lo/ıɨ$If;
