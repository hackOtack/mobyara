...
.field private final mItemPool:Lo/ʢ$ɩ;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, v4}, Lo/ʢ$If;-><init>(I)V

    iput-object v0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mItemPool:Lo/ʢ$ɩ;
    ...
    iput-object v0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mSet:Lo/τ;

    .line 85
    iget-object v0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mSet:Lo/τ;

    invoke-virtual {v0, v2}, Lo/τ;->ˏ(I)Lo/τ;
    ...
    invoke-virtual {v0, v2, v3}, Lo/τ;->ˏ(J)Lo/τ;

    .line 87
    iget-object v0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mSet:Lo/τ;

    new-instance v1, Lo/ıɿ;

    invoke-direct {v1}, Lo/ıɿ;-><init>()V

    invoke-virtual {v0, v1}, Lo/τ;->ˊ(Landroid/animation/TimeInterpolator;)Lo/τ;
...
.method static synthetic access$100(Landroid/support/design/internal/BottomNavigationMenuView;)Lo/іӀ;
    .locals 1

    .prologue
    .line 45
    iget-object v0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mMenu:Lo/іӀ;
...
.method private getNewItem()Landroid/support/design/internal/BottomNavigationItemView;
    ...
    .prologue
    .line 320
    iget-object v0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mItemPool:Lo/ʢ$ɩ;
...
.method public buildMenuView()V
    ...
    .line 260
    iget-object v6, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mItemPool:Lo/ʢ$ɩ;

    invoke-interface {v6, v5}, Lo/ʢ$ɩ;->ˊ(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0}, Lo/іӀ;->size()I
    ...
    invoke-virtual {v0, v3}, Lo/іӀ;->getItem(I)Landroid/view/MenuItem;
    ...
    invoke-virtual {v4, v0, v2}, Landroid/support/design/internal/BottomNavigationItemView;->initialize(Lo/ӀΙ;I)V
    ...
    invoke-virtual {v0, v2}, Lo/іӀ;->getItem(I)Landroid/view/MenuItem;
...
.method public initialize(Lo/іӀ;)V
    .locals 0

    .prologue
    .line 105
    iput-object p1, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mMenu:Lo/іӀ;
...
.method tryRestoreSelectedItemId(I)V
    ...
    .line 334
    iget-object v2, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mMenu:Lo/іӀ;

    invoke-virtual {v2, v0}, Lo/іӀ;->getItem(I)Landroid/view/MenuItem;
...
.method public updateMenuView()V
    ...
    .line 300
    iget-object v4, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mMenu:Lo/іӀ;

    invoke-virtual {v4, v0}, Lo/іӀ;->getItem(I)Landroid/view/MenuItem;
    ...
    invoke-static {p0, v0}, Lo/ıı;->ॱ(Landroid/view/ViewGroup;Lo/ʕ;)V
    ...
    invoke-virtual {v0, v1}, Lo/іӀ;->getItem(I)Landroid/view/MenuItem;
