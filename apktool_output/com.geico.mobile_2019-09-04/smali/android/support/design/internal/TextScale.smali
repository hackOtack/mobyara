...
.method private captureValues(Lo/Г;)V
    .locals 3
...
.method public captureEndValues(Lo/Г;)V
    ...
    .prologue
    .line 45
    invoke-direct {p0, p1}, Landroid/support/design/internal/TextScale;->captureValues(Lo/Г;)V
...
.method public createAnimator(Landroid/view/ViewGroup;Lo/Г;Lo/Г;)Landroid/animation/Animator;
    ...
    iget-object v0, p2, Lo/Г;->ॱ:Landroid/view/View;

    instance-of v0, v0, Landroid/widget/TextView;

    if-eqz v0, :cond_0

    iget-object v0, p3, Lo/Г;->ॱ:Landroid/view/View;
    ...
    .line 64
    iget-object v5, p3, Lo/Г;->ˋ:Ljava/util/Map;
