...
.method private internalMeasureDimensions(II)V
    ...
    invoke-virtual {v12}, Landroid/support/constraint/solver/widgets/ResolutionNode;->invalidate()V
    ...
    invoke-virtual {v10}, Landroid/support/constraint/solver/widgets/ResolutionNode;->isResolved()Z

    move-result v3

    if-eqz v3, :cond_18

    invoke-virtual {v11}, Landroid/support/constraint/solver/widgets/ResolutionNode;->isResolved()Z
    ...
    invoke-virtual/range {v20 .. v20}, Landroid/support/constraint/solver/widgets/ResolutionNode;->isResolved()Z

    move-result v3

    if-eqz v3, :cond_1b

    invoke-virtual/range {v21 .. v21}, Landroid/support/constraint/solver/widgets/ResolutionNode;->isResolved()Z
    ...
    iget-wide v0, v4, Landroid/support/constraint/solver/Metrics;->measures:J
    ...
    iput-wide v0, v4, Landroid/support/constraint/solver/Metrics;->measures:J
    ...
    invoke-virtual {v0, v4}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWidthWrapContent(Z)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setHeightWrapContent(Z)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWidth(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWrapWidth(I)V
    ...
    invoke-virtual {v6, v4}, Landroid/support/constraint/solver/widgets/ResolutionDimension;->resolve(I)V
    ...
    invoke-virtual {v4}, Landroid/support/constraint/solver/widgets/ResolutionDimension;->remove()V
...
.method private setChildrenConstraints()V
    ...
    invoke-virtual {v0}, Landroid/support/constraint/solver/widgets/WidgetContainer;->removeAllChildren()V
    ...
    invoke-virtual {v1, v0}, Landroid/support/constraint/solver/widgets/WidgetContainer;->add(Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .line 943
    :cond_14
    iget v6, v8, Landroid/support/constraint/ConstraintLayout$LayoutParams;->resolvedLeftToLeft:I

    .line 944
    iget v7, v8, Landroid/support/constraint/ConstraintLayout$LayoutParams;->resolvedLeftToRight:I
    ...
    .line 954
    iget v6, v8, Landroid/support/constraint/ConstraintLayout$LayoutParams;->leftToLeft:I

    .line 955
    iget v7, v8, Landroid/support/constraint/ConstraintLayout$LayoutParams;->leftToRight:I
    ...
    .line 964
    iget v6, v8, Landroid/support/constraint/ConstraintLayout$LayoutParams;->startToStart:I
    ...
    .line 966
    iget v7, v8, Landroid/support/constraint/ConstraintLayout$LayoutParams;->startToEnd:I
...
.method private setSelfDimensionBehaviour(II)V
    ...
    invoke-virtual {v5, v1}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setMinWidth(I)V

    .line 1842
    iget-object v5, p0, Landroid/support/constraint/ConstraintLayout;->mLayoutWidget:Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;

    invoke-virtual {v5, v1}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setMinHeight(I)V

    .line 1843
    iget-object v1, p0, Landroid/support/constraint/ConstraintLayout;->mLayoutWidget:Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;

    invoke-virtual {v1, v4}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setHorizontalDimensionBehaviour(Landroid/support/constraint/solver/widgets/ConstraintWidget$DimensionBehaviour;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setMinWidth(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setMinHeight(I)V
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {v2, v8}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setX(I)V
    ...
    invoke-virtual {v2, v9}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setY(I)V
    ...
    invoke-virtual {v2, v3}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setMaxWidth(I)V
    ...
    invoke-virtual {v2, v3}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setMaxHeight(I)V
    ...
    invoke-virtual {v7}, Landroid/support/constraint/solver/widgets/ResolutionNode;->isResolved()Z
    ...
    invoke-virtual {v2, v15}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWidth(I)V
    ...
    invoke-virtual {v2, v9}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWidth(I)V
    ...
    invoke-virtual {v2, v11}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setHeight(I)V
