...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/v4/view/ViewPager$Ӏ;,
        Landroid/support/v4/view/ViewPager$if;,
        Landroid/support/v4/view/ViewPager$IF;,
        Landroid/support/v4/view/ViewPager$ı;,
        Landroid/support/v4/view/ViewPager$aux;,
        Landroid/support/v4/view/ViewPager$ɩ;,
        Landroid/support/v4/view/ViewPager$If;,
        Landroid/support/v4/view/ViewPager$Ι;,
        Landroid/support/v4/view/ViewPager$iF;,
        Landroid/support/v4/view/ViewPager$ι;,
...
.field private static final sPositionComparator:Landroid/support/v4/view/ViewPager$Ӏ;
...
.field private mInternalPageChangeListener:Landroid/support/v4/view/ViewPager$ι;
...
.field private mObserver:Landroid/support/v4/view/ViewPager$IF;

.field private mOffscreenPageLimit:I

.field private mOnPageChangeListener:Landroid/support/v4/view/ViewPager$ι;
...
.field private mPageTransformer:Landroid/support/v4/view/ViewPager$Ι;
...
.field private final mTempItem:Landroid/support/v4/view/ViewPager$ǃ;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Landroid/support/v4/view/ViewPager$3;-><init>()V
    ...
    .line 251
    new-instance v0, Landroid/support/v4/view/ViewPager$Ӏ;

    invoke-direct {v0}, Landroid/support/v4/view/ViewPager$Ӏ;-><init>()V

    sput-object v0, Landroid/support/v4/view/ViewPager;->sPositionComparator:Landroid/support/v4/view/ViewPager$Ӏ;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 156
    new-instance v0, Landroid/support/v4/view/ViewPager$ǃ;

    invoke-direct {v0}, Landroid/support/v4/view/ViewPager$ǃ;-><init>()V

    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->mTempItem:Landroid/support/v4/view/ViewPager$ǃ;
    ...
    .line 269
    new-instance v0, Landroid/support/v4/view/ViewPager$5;

    invoke-direct {v0, p0}, Landroid/support/v4/view/ViewPager$5;-><init>(Landroid/support/v4/view/ViewPager;)V
...
.method private calculatePageOffsets(Landroid/support/v4/view/ViewPager$ǃ;ILandroid/support/v4/view/ViewPager$ǃ;)V
    .locals 12
    ...
    .line 1298
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;
    ...
    .line 1303
    iget v0, p3, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I

    .line 1305
    iget v1, p1, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I

    if-ge v0, v1, :cond_2

    .line 1308
    iget v1, p3, Landroid/support/v4/view/ViewPager$ǃ;->ˋ:F

    iget v2, p3, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
    ...
    check-cast v0, Landroid/support/v4/view/ViewPager$ǃ;

    .line 1312
    :goto_2
    iget v5, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I
    ...
    .line 1319
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;

    invoke-virtual {v5, v2}, Lo/ҫ;->getPageWidth(I)F
    ...
    .line 1322
    :cond_1
    iput v1, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˋ:F

    .line 1323
    iget v0, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
    ...
    .line 1342
    :cond_3
    iget v5, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
    ...
    .line 1350
    iget v1, p1, Landroid/support/v4/view/ViewPager$ǃ;->ˋ:F
    ...
    iget v0, p1, Landroid/support/v4/view/ViewPager$ǃ;->ˋ:F
    ...
    iget v3, p1, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
    ...
    .line 1358
    :goto_a
    iget v3, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I

    if-le v2, v3, :cond_7

    .line 1359
    iget-object v9, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;

    add-int/lit8 v3, v2, -0x1

    invoke-virtual {v9, v2}, Lo/ҫ;->getPageWidth(I)F
    ...
    .line 1361
    :cond_7
    iget v3, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
    ...
    .line 1363
    iget v0, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I
    ...
    iget v1, p1, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
...
.method private completeScroll(Z)V
    ...
    .line 1996
    iget-boolean v5, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˏ:Z

    if-eqz v5, :cond_2

    .line 1998
    iput-boolean v2, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˏ:Z
...
.method private determineTargetPage(IFII)I
    ...
    check-cast v1, Landroid/support/v4/view/ViewPager$ǃ;

    .line 2418
    iget v0, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I

    iget v1, v1, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I
...
.method private dispatchOnPageScrolled(IFI)V
    ...
    .prologue
    .line 1923
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mOnPageChangeListener:Landroid/support/v4/view/ViewPager$ι;
    ...
    invoke-interface {v0, p1, p2, p3}, Landroid/support/v4/view/ViewPager$ι;->onPageScrolled(IFI)V
    ...
    check-cast v0, Landroid/support/v4/view/ViewPager$ι;
    ...
    .line 1934
    :cond_2
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mInternalPageChangeListener:Landroid/support/v4/view/ViewPager$ι;
...
.method private dispatchOnPageSelected(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/view/ViewPager$ι;->onPageSelected(I)V
...
.method private dispatchOnScrollStateChanged(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/view/ViewPager$ι;->onPageScrollStateChanged(I)V
...
.method private infoForCurrentScrollPosition()Landroid/support/v4/view/ViewPager$ǃ;
    .locals 13
    ...
    iget v10, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I
    ...
    .line 2377
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mTempItem:Landroid/support/v4/view/ViewPager$ǃ;
    ...
    iput v6, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˋ:F

    .line 2379
    add-int/lit8 v6, v8, 0x1

    iput v6, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I

    .line 2380
    iget-object v6, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;

    iget v7, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I

    invoke-virtual {v6, v7}, Lo/ҫ;->getPageWidth(I)F

    move-result v6

    iput v6, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
    ...
    .line 2383
    :goto_3
    iget v6, v2, Landroid/support/v4/view/ViewPager$ǃ;->ˋ:F

    .line 2386
    iget v7, v2, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
    ...
    .line 2395
    :cond_5
    iget v5, v2, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I

    .line 2397
    iget v4, v2, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
...
.method private static isDecorView(Landroid/view/View;)Z
    ...
    .line 1499
    const-class v1, Landroid/support/v4/view/ViewPager$ɩ;
...
.method private pageScrolled(I)Z
    ...
    .line 1832
    :cond_2
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->infoForCurrentScrollPosition()Landroid/support/v4/view/ViewPager$ǃ;
    ...
    .line 1836
    iget v5, v1, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I
    ...
    iget v6, v1, Landroid/support/v4/view/ViewPager$ǃ;->ˋ:F

    sub-float/2addr v2, v6

    iget v1, v1, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
...
.method private performDrag(F)Z
    ...
    .line 2326
    iget v8, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I

    if-eqz v8, :cond_5

    .line 2328
    iget v0, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˋ:F
    ...
    .line 2330
    :goto_0
    iget v8, v1, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I

    iget-object v9, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;

    invoke-virtual {v9}, Lo/ҫ;->getCount()I
    ...
    .line 2332
    iget v1, v1, Landroid/support/v4/view/ViewPager$ǃ;->ˋ:F
...
.method private recomputeScrollPosition(IIII)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/view/ViewPager;->infoForPosition(I)Landroid/support/v4/view/ViewPager$ǃ;
...
.method private scrollToItem(IZIZ)V
    ...
    .line 676
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->infoForPosition(I)Landroid/support/v4/view/ViewPager$ǃ;
...
.method private sortChildDrawingOrder()V
    ...
    sget-object v1, Landroid/support/v4/view/ViewPager;->sPositionComparator:Landroid/support/v4/view/ViewPager$Ӏ;
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    .line 2913
    invoke-virtual {p0, v3}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$ǃ;
    ...
    iget v4, v4, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I
...
.method addNewItem(II)Landroid/support/v4/view/ViewPager$ǃ;
    .locals 2
    ...
    .line 1009
    iput p1, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I

    .line 1010
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;

    invoke-virtual {v1, p0, p1}, Lo/ҫ;->instantiateItem(Landroid/view/ViewGroup;I)Ljava/lang/Object;

    move-result-object v1

    iput-object v1, v0, Landroid/support/v4/view/ViewPager$ǃ;->ॱ:Ljava/lang/Object;

    .line 1011
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;

    invoke-virtual {v1, p1}, Lo/ҫ;->getPageWidth(I)F

    move-result v1

    iput v1, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
...
.method public addOnAdapterChangeListener(Landroid/support/v4/view/ViewPager$If;)V
    .locals 1
...
.method public addOnPageChangeListener(Landroid/support/v4/view/ViewPager$ι;)V
    .locals 1
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    .line 2953
    invoke-virtual {p0, v1}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$ǃ;
    ...
    iget v2, v2, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    iput-boolean v2, v0, Landroid/support/v4/view/ViewPager$if;->ॱ:Z
    ...
    iput-boolean v2, v0, Landroid/support/v4/view/ViewPager$if;->ˋ:Z
...
.method public canScrollHorizontally(I)Z
    ...
    .line 2692
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;
...
.method dataSetChanged()V
    ...
    .line 1032
    iget-object v7, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;

    iget-object v9, v0, Landroid/support/v4/view/ViewPager$ǃ;->ॱ:Ljava/lang/Object;

    invoke-virtual {v7, v9}, Lo/ҫ;->getItemPosition(Ljava/lang/Object;)I
    ...
    .line 1043
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;

    invoke-virtual {v4, p0}, Lo/ҫ;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v6, p0, v7, v9}, Lo/ҫ;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    .line 1058
    :cond_2
    iget v9, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I

    if-eq v9, v7, :cond_9

    .line 1059
    iget v6, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I
    ...
    .line 1064
    :cond_3
    iput v7, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I
    ...
    invoke-virtual {v0, p0}, Lo/ҫ;->finishUpdate(Landroid/view/ViewGroup;)V
    ...
    .line 1081
    iget-boolean v6, v0, Landroid/support/v4/view/ViewPager$if;->ॱ:Z
    ...
    iput v6, v0, Landroid/support/v4/view/ViewPager$if;->ˏ:F
...
.method public endFakeDrag()V
    ...
    .line 2566
    iget v4, v3, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I
    ...
    iget v2, v3, Landroid/support/v4/view/ViewPager$ǃ;->ˋ:F

    sub-float/2addr v1, v2

    iget v2, v3, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
...
.method public fakeDragBy(F)V
    ...
    .line 2608
    :goto_1
    iget v2, v1, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I

    iget-object v6, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;

    invoke-virtual {v6}, Lo/ҫ;->getCount()I
...
.method protected getChildDrawingOrder(II)I
    ...
    iget v0, v0, Landroid/support/v4/view/ViewPager$if;->ʽ:I
...
.method infoForAnyChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$ǃ;
    .locals 2
    ...
    .line 1529
    :cond_2
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$ǃ;
...
.method infoForChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$ǃ;
    .locals 4
    ...
    iget-object v3, v0, Landroid/support/v4/view/ViewPager$ǃ;->ॱ:Ljava/lang/Object;

    invoke-virtual {v2, p1, v3}, Lo/ҫ;->isViewFromObject(Landroid/view/View;Ljava/lang/Object;)Z
...
.method infoForPosition(I)Landroid/support/v4/view/ViewPager$ǃ;
    .locals 3
    ...
    .line 1535
    iget v2, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I
...
.method initViewPager()V
    ...
    .line 419
    new-instance v0, Landroid/support/v4/view/ViewPager$ı;

    invoke-direct {v0, p0}, Landroid/support/v4/view/ViewPager$ı;-><init>(Landroid/support/v4/view/ViewPager;)V
    ...
    .line 423
    invoke-static {p0, v4}, Lo/ҷ;->ˎ(Landroid/view/View;I)V

    .line 427
    :cond_0
    new-instance v0, Landroid/support/v4/view/ViewPager$1;

    invoke-direct {v0, p0}, Landroid/support/v4/view/ViewPager$1;-><init>(Landroid/support/v4/view/ViewPager;)V

    invoke-static {p0, v0}, Lo/ҷ;->ॱ(Landroid/view/View;Lo/ү;)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;
    ...
    .line 2478
    iget v4, v1, Landroid/support/v4/view/ViewPager$ǃ;->ˋ:F
    ...
    .line 2480
    iget v3, v1, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I
    ...
    check-cast v2, Landroid/support/v4/view/ViewPager$ǃ;

    iget v10, v2, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I
    ...
    .line 2489
    iget v3, v1, Landroid/support/v4/view/ViewPager$ǃ;->ˋ:F

    iget v4, v1, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
    ...
    iget v11, v1, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
    ...
    iget-object v3, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;

    invoke-virtual {v3, v5}, Lo/ҫ;->getPageWidth(I)F
...
.method protected onLayout(ZIIII)V
    ...
    .line 1701
    iget-boolean v7, v1, Landroid/support/v4/view/ViewPager$if;->ॱ:Z

    if-eqz v7, :cond_5

    .line 1702
    iget v7, v1, Landroid/support/v4/view/ViewPager$if;->ˊ:I

    and-int/lit8 v7, v7, 0x7

    .line 1703
    iget v1, v1, Landroid/support/v4/view/ViewPager$if;->ˊ:I
    ...
    .line 1754
    iget-boolean v10, v1, Landroid/support/v4/view/ViewPager$if;->ॱ:Z

    if-nez v10, :cond_2

    move-object/from16 v0, p0

    invoke-virtual {v0, v8}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$ǃ;
    ...
    iget v10, v10, Landroid/support/v4/view/ViewPager$ǃ;->ˋ:F
    ...
    .line 1758
    iget-boolean v12, v1, Landroid/support/v4/view/ViewPager$if;->ˋ:Z
    ...
    iput-boolean v12, v1, Landroid/support/v4/view/ViewPager$if;->ˋ:Z

    .line 1762
    int-to-float v12, v7

    iget v1, v1, Landroid/support/v4/view/ViewPager$if;->ˏ:F
...
.method protected onMeasure(II)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/view/ViewPager$if;->ॱ:Z

    if-eqz v1, :cond_3

    .line 1577
    iget v1, v0, Landroid/support/v4/view/ViewPager$if;->ˊ:I
    ...
    iget-boolean v5, v0, Landroid/support/v4/view/ViewPager$if;->ॱ:Z
    ...
    iget v0, v0, Landroid/support/v4/view/ViewPager$if;->ˏ:F
...
.method protected onPageScrolled(IFI)V
    ...
    .line 1874
    iget-boolean v9, v0, Landroid/support/v4/view/ViewPager$if;->ॱ:Z

    if-eqz v9, :cond_4

    .line 1876
    iget v0, v0, Landroid/support/v4/view/ViewPager$if;->ˊ:I
    ...
    .line 1906
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mPageTransformer:Landroid/support/v4/view/ViewPager$Ι;
    ...
    .line 1915
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->mPageTransformer:Landroid/support/v4/view/ViewPager$Ι;

    invoke-interface {v5, v3, v0}, Landroid/support/v4/view/ViewPager$Ι;->transformPage(Landroid/view/View;F)V
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    .line 2983
    invoke-virtual {p0, v5}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$ǃ;
    ...
    iget v6, v6, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .prologue
    .line 1452
    instance-of v0, p1, Landroid/support/v4/view/ViewPager$aux;
    ...
    .line 1457
    :cond_0
    check-cast p1, Landroid/support/v4/view/ViewPager$aux;
    ...
    iget-object v1, p1, Landroid/support/v4/view/ViewPager$aux;->ˎ:Landroid/os/Parcelable;

    iget-object v2, p1, Landroid/support/v4/view/ViewPager$aux;->ˋ:Ljava/lang/ClassLoader;

    invoke-virtual {v0, v1, v2}, Lo/ҫ;->restoreState(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V

    .line 1462
    iget v0, p1, Landroid/support/v4/view/ViewPager$aux;->ˏ:I
    ...
    .line 1465
    iget-object v0, p1, Landroid/support/v4/view/ViewPager$aux;->ˎ:Landroid/os/Parcelable;

    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->mRestoredAdapterState:Landroid/os/Parcelable;

    .line 1466
    iget-object v0, p1, Landroid/support/v4/view/ViewPager$aux;->ˋ:Ljava/lang/ClassLoader;
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 1442
    new-instance v1, Landroid/support/v4/view/ViewPager$aux;

    invoke-direct {v1, v0}, Landroid/support/v4/view/ViewPager$aux;-><init>(Landroid/os/Parcelable;)V

    .line 1443
    iget v0, p0, Landroid/support/v4/view/ViewPager;->mCurItem:I

    iput v0, v1, Landroid/support/v4/view/ViewPager$aux;->ˏ:I
    ...
    invoke-virtual {v0}, Lo/ҫ;->saveState()Landroid/os/Parcelable;

    move-result-object v0

    iput-object v0, v1, Landroid/support/v4/view/ViewPager$aux;->ˎ:Landroid/os/Parcelable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 2255
    iget v6, v4, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I
    ...
    iget v3, v4, Landroid/support/v4/view/ViewPager$ǃ;->ˋ:F

    sub-float/2addr v2, v3

    iget v3, v4, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
...
.method pageRight()Z
    ...
    invoke-virtual {v2}, Lo/ҫ;->getCount()I
...
.method populate(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->infoForPosition(I)Landroid/support/v4/view/ViewPager$ǃ;
    ...
    iget-object v2, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;
    ...
    invoke-virtual {v2, v0}, Lo/ҫ;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    iget-object v4, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;

    invoke-virtual {v4}, Lo/ҫ;->getCount()I
    ...
    .line 1151
    iget v6, v2, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I
    ...
    invoke-virtual {v0, v2, v4}, Landroid/support/v4/view/ViewPager;->addNewItem(II)Landroid/support/v4/view/ViewPager$ǃ;
    ...
    .line 1176
    iget v14, v2, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I

    if-ne v8, v14, :cond_4

    iget-boolean v14, v2, Landroid/support/v4/view/ViewPager$ǃ;->ˏ:Z
    ...
    invoke-virtual {v14, v4}, Ljava/util/AbstractList;->remove(I)Ljava/lang/Object;

    .line 1178
    move-object/from16 v0, p0

    iget-object v14, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;

    iget-object v2, v2, Landroid/support/v4/view/ViewPager$ǃ;->ॱ:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v14, v0, v8, v2}, Lo/ҫ;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    iget v6, v9, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
    ...
    .line 1188
    iget v2, v2, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
    ...
    invoke-virtual {v0, v8, v2}, Landroid/support/v4/view/ViewPager;->addNewItem(II)Landroid/support/v4/view/ViewPager$ǃ;
    ...
    .line 1199
    :cond_d
    iget v5, v9, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F
    ...
    iget-boolean v10, v2, Landroid/support/v4/view/ViewPager$ǃ;->ˏ:Z
    ...
    iget-object v10, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;

    iget-object v2, v2, Landroid/support/v4/view/ViewPager$ǃ;->ॱ:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v10, v0, v8, v2}, Lo/ҫ;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v8, v6}, Landroid/support/v4/view/ViewPager;->addNewItem(II)Landroid/support/v4/view/ViewPager$ǃ;
    ...
    invoke-direct {v0, v9, v7, v3}, Landroid/support/v4/view/ViewPager;->calculatePageOffsets(Landroid/support/v4/view/ViewPager$ǃ;ILandroid/support/v4/view/ViewPager$ǃ;)V
    ...
    iget-object v4, v9, Landroid/support/v4/view/ViewPager$ǃ;->ॱ:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v2, v0, v3, v4}, Lo/ҫ;->setPrimaryItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v2, v0}, Lo/ҫ;->finishUpdate(Landroid/view/ViewGroup;)V
    ...
    check-cast v2, Landroid/support/v4/view/ViewPager$if;

    .line 1252
    iput v3, v2, Landroid/support/v4/view/ViewPager$if;->ʽ:I

    .line 1253
    iget-boolean v6, v2, Landroid/support/v4/view/ViewPager$if;->ॱ:Z

    if-nez v6, :cond_17

    iget v6, v2, Landroid/support/v4/view/ViewPager$if;->ˏ:F
    ...
    invoke-virtual {v0, v5}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$ǃ;
    ...
    .line 1257
    iget v6, v5, Landroid/support/v4/view/ViewPager$ǃ;->ˎ:F

    iput v6, v2, Landroid/support/v4/view/ViewPager$if;->ˏ:F

    .line 1258
    iget v5, v5, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I

    iput v5, v2, Landroid/support/v4/view/ViewPager$if;->ˎ:I
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->infoForAnyChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$ǃ;
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$ǃ;
...
.method public removeOnAdapterChangeListener(Landroid/support/v4/view/ViewPager$If;)V
    .locals 1
...
.method public removeOnPageChangeListener(Landroid/support/v4/view/ViewPager$ι;)V
    .locals 1
...
.method public setAdapter(Lo/ҫ;)V
    .locals 7
    ...
    invoke-virtual {v0, v5}, Lo/ҫ;->setViewPagerObserver(Landroid/database/DataSetObserver;)V

    .line 508
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;

    invoke-virtual {v0, p0}, Lo/ҫ;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    .line 511
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;

    iget v4, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˊ:I

    iget-object v0, v0, Landroid/support/v4/view/ViewPager$ǃ;->ॱ:Ljava/lang/Object;

    invoke-virtual {v3, p0, v4, v0}, Lo/ҫ;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    .line 521
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;
    ...
    .line 525
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mObserver:Landroid/support/v4/view/ViewPager$IF;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/view/ViewPager$IF;-><init>(Landroid/support/v4/view/ViewPager;)V

    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->mObserver:Landroid/support/v4/view/ViewPager$IF;

    .line 528
    :cond_2
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lo/ҫ;

    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->mObserver:Landroid/support/v4/view/ViewPager$IF;

    invoke-virtual {v0, v3}, Lo/ҫ;->setViewPagerObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {v3}, Lo/ҫ;->getCount()I
    ...
    invoke-virtual {v0, v3, v4}, Lo/ҫ;->restoreState(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
    ...
    invoke-interface {v0, p0, v1, p1}, Landroid/support/v4/view/ViewPager$If;->onAdapterChanged(Landroid/support/v4/view/ViewPager;Lo/ҫ;Lo/ҫ;)V
...
.method setCurrentItemInternal(IZZI)V
    ...
    iput-boolean v3, v0, Landroid/support/v4/view/ViewPager$ǃ;->ˏ:Z
...
.method setInternalPageChangeListener(Landroid/support/v4/view/ViewPager$ι;)Landroid/support/v4/view/ViewPager$ι;
    .locals 1
    ...
    .line 816
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->mInternalPageChangeListener:Landroid/support/v4/view/ViewPager$ι;
...
.method public setOnPageChangeListener(Landroid/support/v4/view/ViewPager$ι;)V
    .locals 0
    ...
    .prologue
    .line 709
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->mOnPageChangeListener:Landroid/support/v4/view/ViewPager$ι;
...
.method public setPageTransformer(ZLandroid/support/v4/view/ViewPager$Ι;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, p2, v0}, Landroid/support/v4/view/ViewPager;->setPageTransformer(ZLandroid/support/v4/view/ViewPager$Ι;I)V

    .line 770
    return-void
.end method

.method public setPageTransformer(ZLandroid/support/v4/view/ViewPager$Ι;I)V
    .locals 4
    ...
    .line 788
    :goto_0
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->mPageTransformer:Landroid/support/v4/view/ViewPager$Ι;
    ...
    .line 789
    :goto_2
    iput-object p2, p0, Landroid/support/v4/view/ViewPager;->mPageTransformer:Landroid/support/v4/view/ViewPager$Ι;
...
.method smoothScrollTo(III)V
    ...
    invoke-virtual {v5, v7}, Lo/ҫ;->getPageWidth(I)F
