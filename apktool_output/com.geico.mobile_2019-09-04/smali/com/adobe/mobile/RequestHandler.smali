...
.method protected static retrieveData(Ljava/lang/String;ILjava/lang/String;Ljava/util/concurrent/Callable;Lcom/adobe/mobile/RequestHandler$HeaderCallback;)[B
    ...
    invoke-virtual {v5, v1, v8, v7}, Ljava/io/OutputStream;->write([BII)V
    :try_end_1
    ...
    invoke-interface {p4, v2}, Lcom/adobe/mobile/RequestHandler$HeaderCallback;->call(Ljava/util/Map;)V
    ...
    invoke-direct {v7, v8, v5}, Ljava/net/URL;-><init>(Ljava/net/URL;Ljava/lang/String;)V
...
.method protected static retrieveNetworkObject(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)Lcom/adobe/mobile/NetworkObject;
    ...
    invoke-virtual {v3, v1, p4}, Ljava/net/URLConnection;->setRequestProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 457
    :try_start_1
    const-string v4, "%s - ProtocolException while trying to get content (%s)"
    ...
    .line 460
    :try_start_5
    const-string v4, "%s - NullPointerException while trying to get content (%s)"
    ...
    .line 463
    :try_start_7
    const-string v4, "%s - IOException while trying to get content (%s)"
    ...
    .line 466
    :try_start_9
    const-string v4, "%s - Exception while trying to get content (%s)"
...
.method protected static sendGenericRequest(Ljava/lang/String;Ljava/util/Map;ILjava/lang/String;)V
    ...
    const-string v1, "%s - Timed out sending request(%s)"
    ...
    .line 229
    const-string v2, "%s - IOException while sending request, may retry(%s)"
    ...
    .line 231
    const-string v2, "%s - Exception while attempting to send hit, will not retry(%s)"
...
.method protected static sendThirdPartyRequest(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;ILjava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v5, v6, v1}, Ljava/net/URLConnection;->setRequestProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 371
    const-string v1, "%s - Successfully forwarded hit (%s body: %s type: %s)"
    ...
    .line 378
    const-string v2, "%s - IOException while sending request, will not retry (%s)"
    ...
    invoke-static {v2, v5}, Lcom/adobe/mobile/StaticMethods;->logErrorFormat(Ljava/lang/String;[Ljava/lang/Object;)V
