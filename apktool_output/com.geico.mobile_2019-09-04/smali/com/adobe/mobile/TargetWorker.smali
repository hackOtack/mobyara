...
.method private static forwardAnalyticsForTargetPayload(Lorg/json/JSONObject;)V
    ...
    .line 1061
    const-string v1, "Target - could not forward payload to Analytics (%s)"
    ...
    :cond_2
    :try_start_1
    const-string v0, "AnalyticsForTarget"
...
.method private static getJsonObjectForParameters(Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)Lorg/json/JSONObject;
    ...
    .line 523
    const-string v1, "clientSideAnalyticsLogging"
    ...
    .line 544
    const-string v2, "profileParameters"
    ...
    .line 556
    const-string v2, "mboxParameters"
    ...
    .line 568
    const-string v1, "Target - JSONException while trying to get content (%s)"
...
.method private static getMboxParameters(Ljava/util/Map;)Lorg/json/JSONObject;
    ...
    .line 798
    const-string v1, "Target - JSONException adding mbox parameter to target request (%s)"
...
.method private static getOrderParameters(Ljava/util/Map;)Lorg/json/JSONObject;
    ...
    .line 686
    const-string v1, "Target - NumberFormatException while creating order details (%s)"
    ...
    .line 701
    const-string v1, "Target - JSONException while creating order details (%s)"
...
.method private static getOrderParametersFromMboxParameters(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 750
    const-string v3, "purchasedProductIds"
    ...
    .line 764
    const-string v1, "purchasedProductIds"
...
.method private static getProfileParameters(Ljava/util/Map;)Lorg/json/JSONObject;
    ...
    .line 854
    const-string v1, "Target - Error adding profile parameters to target request (%s)"
...
.method private static getRequestLocationParameters(Ljava/util/Map;)Lorg/json/JSONObject;
    ...
    .line 872
    const-string v1, "Target - Error adding requestLocation parameters to target request (%s)"
...
.method private static getRequestUrl()Ljava/lang/String;
    ...
    .line 930
    :cond_0
    const-string v0, "%s.tt.omtrdc.net"
    ...
    .line 933
    :cond_1
    const-string v2, "https://%s/rest/v1/mbox/%s?client=%s"
...
.method protected static getSessionId()Ljava/lang/String;
    ...
    .line 316
    const-string v3, "ADBMOBILE_TARGET_SESSION_ID"
...
.method private static getVisitorIdParameters()Lorg/json/JSONObject;
    ...
    .line 836
    const-string v1, "Target - JSONException when adding Visitor ID data to Target request (%s)"
...
.method protected static loadRequest(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Lcom/adobe/mobile/Target$TargetCallback;)V
    ...
    .line 176
    :cond_3
    const-string v0, "Target - \"mboxName\" parameter is required for Target calls - returning default content"
...
.method protected static setEdgeHost(Ljava/lang/String;)V
    ...
    .line 1020
    :cond_0
    const-string v2, "ADBMOBILE_TARGET_EDGE_HOST"
...
.method private static setSessionIdInternal(Ljava/lang/String;)V
    ...
    .line 957
    const-string v1, "ADBMOBILE_TARGET_SESSION_ID"
    ...
    .line 966
    const-string v1, "ADBMOBILE_TARGET_LAST_TIMESTAMP"
...
.method protected static setThirdPartyId(Ljava/lang/String;)V
    ...
    .line 221
    :cond_2
    const-string v2, "ADBMOBILE_TARGET_3RD_PARTY_ID"
