...
.method private static addNonInstallData(Ljava/util/Map;J)V
    ...
    .line 701
    const-string v4, "a.OSVersion"

    const-string v5, "ADOBEMOBILE_STOREDDEFAULTS_OS"
    ...
    .line 702
    const-string v4, "a.AppID"

    const-string v5, "ADOBEMOBILE_STOREDDEFAULTS_APPID"
    ...
    .line 711
    const-string v1, "Config - Unable to get crash data for backdated hit (%s)"
...
.method private static addSessionLengthData(Ljava/util/Map;)V
    ...
    const-string v3, "a.PrevSessionLength"
    ...
    .line 767
    :try_start_3
    const-string v1, "Config - Unable to get session data for backdated hit (%s)"
...
.method private static getReferrerDataFromSharedPreferences()Ljava/util/Map;
    ...
    .line 484
    const-string v2, "Lifecycle - Error pulling persisted Acquisition data (%s)"
    ...
    .line 469
    const-string v4, "googleReferrerData"
    ...
    .line 470
    const-string v4, "ADMS_Referrer_ContextData_Json_String"
    ...
    .line 473
    :try_start_3
    const-string v3, "Analytics - Error persisting referrer data (%s)"
...
.method private static isApplicationUpgrade()Z
    ...
    const-string v4, "ADMS_LastVersion"
    ...
    .line 567
    const-string v3, "Lifecycle - Unable to get application version (%s)"
...
.method protected static start(Landroid/app/Activity;Ljava/util/Map;)V
    ...
    .line 127
    const-string v1, "Lifecycle - Error while updating start time (%s)."
