...
# virtual methods
.method protected final initWithPayloadObject(Lorg/json/JSONObject;)Z
    .locals 6
    ...
    .line 110
    :goto_2
    const-string v2, "Message created with: \n MessageID: \"%s\" \n Content: \"%s\" \n Delay: \"%d\" \n Deeplink: \"%s\" \n User Data: \"%s\""
    ...
    const-string v3, "Messages - Tried to read deeplink for local notification message but found none.  This is not a required field"
    ...
    const-string v2, "Messages - Tried to read userData for local notification message but found none.  This is not a required field"
