...
.method protected initWithPayloadObject(Lorg/json/JSONObject;)Z
    ...
    .line 86
    const-string v2, "%s - Unable to create data callback %s, \"payload\" is empty"
    ...
    const-string v2, "%s - Unable to create create data callback %s, \"payload\" is required"
    ...
    .line 99
    const-string v2, "%s - Unable to create data callback %s, \"templateurl\" is empty"
    ...
    const-string v2, "%s - Unable to create data callback %s, \"templateurl\" is required"
    ...
    const-string v2, "%s - Tried to read \"timeout\" for data callback, but found none.  Using default value of two (2) seconds"
    ...
    const-string v2, "%s - Tried to read \"contenttype\" for data callback, but found none.  This is not a required field"
