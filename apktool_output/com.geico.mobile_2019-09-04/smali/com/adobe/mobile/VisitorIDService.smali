...
.method private _getAnalyticsID(JLjava/util/concurrent/TimeUnit;)Ljava/lang/String;
    ...
    .line 660
    const-string v1, "ID Service - error retrieving AID (%s)"
    ...
    .line 664
    const-string v1, "ID Service - Timeout exceeded when retrieving AID (%s)"
...
.method private _getAnalyticsVID(JLjava/util/concurrent/TimeUnit;)Ljava/lang/String;
    ...
    .line 680
    const-string v1, "ID Service - error retrieving VID (%s)"
    ...
    .line 684
    const-string v1, "ID Service - Timeout exceeded when retrieving VID (%s)"
...
.method private _getMarketingCloudID(JLjava/util/concurrent/TimeUnit;)Ljava/lang/String;
    ...
    .line 700
    const-string v1, "ID Service - error retrieving MID (%s)"
    ...
    .line 704
    const-string v1, "ID Service - Timeout exceeded when retrieving MID (%s)"
...
.method private _parseIdString(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 908
    const-string v1, "ID Service - Unable to parse visitor ID: (%s) exception:(%s)"
...
.method protected final getAnalyticsIdString()Ljava/lang/String;
    ...
    .line 445
    const-string v1, "ID Service - Unable to retrieve analytics id string from queue(%s)"
...
.method protected final getIdentifiers()Ljava/util/List;
    ...
    .line 358
    const-string v1, "ID Service - Unable to retrieve marketing cloud identifiers from queue(%s)"
...
.method protected final getVisitorIDServiceExecutor()Ljava/util/concurrent/ExecutorService;
    .locals 1
...
.method protected final idSync(Ljava/util/Map;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected final idSync(Ljava/util/Map;Lcom/adobe/mobile/VisitorID$VisitorIDAuthenticationState;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected final idSync(Ljava/util/Map;Ljava/util/Map;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected final idSync(Ljava/util/Map;Ljava/util/Map;Lcom/adobe/mobile/VisitorID$VisitorIDAuthenticationState;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected final idSync(Ljava/util/Map;Ljava/util/Map;Lcom/adobe/mobile/VisitorID$VisitorIDAuthenticationState;Z)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected final resetVariablesFromSharedPreferences()V
    .locals 4
    ...
    .line 129
    const-string v1, "ID Service - Unable to initialize visitor ID variables(%s)"
