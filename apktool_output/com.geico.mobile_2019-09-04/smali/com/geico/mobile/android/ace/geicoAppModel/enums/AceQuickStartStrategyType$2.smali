.class final enum Lcom/geico/mobile/android/ace/geicoAppModel/enums/AceQuickStartStrategyType$2;
...
.method public final acceptVisitor(Lcom/geico/mobile/android/ace/geicoAppModel/enums/AceQuickStartStrategyType$AceQuickStartStrategyTypeVisitor;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .prologue
    .line 60
    invoke-interface {p1, p2}, Lcom/geico/mobile/android/ace/geicoAppModel/enums/AceQuickStartStrategyType$AceQuickStartStrategyTypeVisitor;->visitSingleDriverMultipleVehicles(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final bridge synthetic isApplicable(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/geico/mobile/android/ace/geicoAppModel/enums/AceQuickStartStrategyType$2;->isApplicable(Lcom/geico/mobile/android/ace/geicoAppModel/AceVehiclePolicy;)Z
...
.method public final isEligibleForQuickStart(Lcom/geico/mobile/android/ace/geicoAppModel/AceVehiclePolicy;Lcom/geico/mobile/android/ace/geicoAppModel/userProfile/AceUserProfilePerson;)Z
    ...
    .prologue
    .line 55
    invoke-virtual {p0, p2}, Lcom/geico/mobile/android/ace/geicoAppModel/enums/AceQuickStartStrategyType$2;->isPrimaryVehicleNotSpecialty(Lcom/geico/mobile/android/ace/geicoAppModel/userProfile/AceUserProfilePerson;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p2}, Lcom/geico/mobile/android/ace/geicoAppModel/enums/AceQuickStartStrategyType$2;->isFullNameNotEmpty(Lcom/geico/mobile/android/ace/geicoAppModel/userProfile/AceUserProfilePerson;)Z
    ...
    invoke-virtual {p0, p2, v0}, Lcom/geico/mobile/android/ace/geicoAppModel/enums/AceQuickStartStrategyType$2;->hasPhoneNumber(Lcom/geico/mobile/android/ace/geicoAppModel/userProfile/AceUserProfilePerson;Lcom/geico/mobile/android/ace/geicoAppModel/AceContactInformation;)Z
