...
.method constructor <init>(Lcom/google/android/gms/vision/text/Line;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/ml/vision/text/FirebaseVisionText$Line;->zzazn:Ljava/util/List;
    ...
    .line 5
    instance-of v2, v0, Lcom/google/android/gms/vision/text/Element;

    if-eqz v2, :cond_0

    .line 6
    iget-object v2, p0, Lcom/google/firebase/ml/vision/text/FirebaseVisionText$Line;->zzazn:Ljava/util/List;

    new-instance v3, Lcom/google/firebase/ml/vision/text/FirebaseVisionText$Element;

    check-cast v0, Lcom/google/android/gms/vision/text/Element;

    invoke-direct {v3, v0}, Lcom/google/firebase/ml/vision/text/FirebaseVisionText$Element;-><init>(Lcom/google/android/gms/vision/text/Element;)V
    ...
    const-string v2, "A subcomponent of line is should be an element!"
...
.method public constructor <init>(Ljava/lang/String;Landroid/graphics/Rect;Ljava/util/List;Ljava/util/List;Ljava/lang/Float;)V
    ...
    .line 11
    iput-object p4, p0, Lcom/google/firebase/ml/vision/text/FirebaseVisionText$Line;->zzazn:Ljava/util/List;
...
.method public declared-synchronized getElements()Ljava/util/List;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/ml/vision/text/FirebaseVisionText$Line;->zzazn:Ljava/util/List;
    :try_end_0
