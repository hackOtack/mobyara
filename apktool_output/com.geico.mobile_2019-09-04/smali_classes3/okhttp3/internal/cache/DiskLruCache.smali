...
.method private newJournalWriter()Lo/NY;
    .locals 2
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->appendingSink(Ljava/io/File;)Lo/Ol;
    ...
    invoke-direct {v1, p0, v0}, Lokhttp3/internal/cache/DiskLruCache$2;-><init>(Lokhttp3/internal/cache/DiskLruCache;Lo/Ol;)V

    .line 322
    invoke-static {v1}, Lo/Oe;->ˊ(Lo/Ol;)Lo/NY;
...
.method private readJournal()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lo/On;
    ...
    .line 278
    :try_start_0
    invoke-interface {v1}, Lo/NV;->ˋॱ()Ljava/lang/String;
    ...
    :cond_2
    :try_start_3
    invoke-direct {p0}, Lokhttp3/internal/cache/DiskLruCache;->newJournalWriter()Lo/NY;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lo/NY;
    :try_end_3
...
.method public final declared-synchronized close()V
    ...
    .line 677
    iget-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lo/NY;
...
.method final declared-synchronized completeEdit(Lokhttp3/internal/cache/DiskLruCache$Editor;Z)V
    ...
    invoke-virtual {v2, v0}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Lo/NY;)V
...
.method final declared-synchronized edit(Ljava/lang/String;J)Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    .line 486
    :cond_4
    iget-object v2, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lo/NY;
    ...
    invoke-interface {v2, v3}, Lo/NY;->ॱॱ(I)Lo/NY;

    move-result-object v2

    invoke-interface {v2, p1}, Lo/NY;->ˊ(Ljava/lang/String;)Lo/NY;
    ...
    invoke-interface {v2}, Lo/NY;->flush()V
...
.method public final declared-synchronized get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 447
    iget-object v1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lo/NY;

    const-string v2, "READ"

    invoke-interface {v1, v2}, Lo/NY;->ˊ(Ljava/lang/String;)Lo/NY;

    move-result-object v1

    const/16 v2, 0x20

    invoke-interface {v1, v2}, Lo/NY;->ॱॱ(I)Lo/NY;

    move-result-object v1

    invoke-interface {v1, p1}, Lo/NY;->ˊ(Ljava/lang/String;)Lo/NY;
...
.method final declared-synchronized rebuildJournal()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lo/Ol;
    ...
    invoke-interface {v1, v0}, Lo/NY;->ˊ(Ljava/lang/String;)Lo/NY;

    move-result-object v0

    const/16 v2, 0xa

    invoke-interface {v0, v2}, Lo/NY;->ॱॱ(I)Lo/NY;
    ...
    invoke-interface {v1, v2, v3}, Lo/NY;->ॱˊ(J)Lo/NY;
    ...
    invoke-interface {v1, v0}, Lo/NY;->ॱॱ(I)Lo/NY;
    ...
    invoke-interface {v1, v3}, Lo/NY;->ˊ(Ljava/lang/String;)Lo/NY;

    move-result-object v3

    const/16 v4, 0x20

    invoke-interface {v3, v4}, Lo/NY;->ॱॱ(I)Lo/NY;
    ...
    :try_start_2
    invoke-interface {v1}, Lo/NY;->close()V
    ...
    .line 412
    invoke-virtual {v0, v1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Lo/NY;)V
