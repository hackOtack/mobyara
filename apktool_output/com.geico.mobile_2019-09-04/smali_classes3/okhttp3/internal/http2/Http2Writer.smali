...
.field private final hpackBuffer:Lo/NX;

.field final hpackWriter:Lokhttp3/internal/http2/Hpack$Writer;

.field private maxFrameSize:I

.field private final sink:Lo/NY;
...
.method constructor <init>(Lo/NY;Z)V
    .locals 2
    ...
    .line 58
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lo/NY;
    ...
    iput-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lo/NX;

    .line 61
    new-instance v0, Lokhttp3/internal/http2/Hpack$Writer;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lo/NX;

    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(Lo/NX;)V
...
.method private writeContinuationFrames(IJ)V
    ...
    .line 293
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lo/NY;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lo/NX;

    int-to-long v4, v1

    invoke-interface {v0, v2, v4, v5}, Lo/NY;->write(Lo/NX;J)V
...
.method private static writeMedium(Lo/NY;I)V
    .locals 1
    ...
    invoke-interface {p0, v0}, Lo/NY;->ॱॱ(I)Lo/NY;
...
.method public final declared-synchronized connectionPreface()V
    ...
    sget-object v4, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lo/NU;

    invoke-virtual {v4}, Lo/NU;->ʽ()Ljava/lang/String;
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lo/NU;

    invoke-virtual {v1}, Lo/NU;->ॱॱ()[B

    move-result-object v1

    invoke-interface {v0, v1}, Lo/NY;->ˏ([B)Lo/NY;
...
.method public final declared-synchronized data(ZILo/NX;I)V
    .locals 2
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p0, p2, v0, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IBLo/NX;I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method final dataFrame(IBLo/NX;I)V
    .locals 4
    ...
    invoke-interface {v0, p3, v2, v3}, Lo/NY;->write(Lo/NX;J)V
...
.method public final frameHeader(IIBB)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/http2/Http2Writer;->writeMedium(Lo/NY;I)V
    ...
    invoke-interface {v0, v1}, Lo/NY;->ॱॱ(I)Lo/NY;
    ...
    invoke-interface {v0, v1}, Lo/NY;->ʼ(I)Lo/NY;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lo/NY;->ʼ(I)Lo/NY;
    ...
    invoke-interface {v0, p3}, Lo/NY;->ˏ([B)Lo/NY;
...
.method final headers(ZILjava/util/List;)V
    ...
    .line 301
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lo/NX;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lo/NX;

    int-to-long v6, v1

    invoke-interface {v0, v4, v6, v7}, Lo/NY;->write(Lo/NX;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {v0, p2}, Lo/NY;->ʼ(I)Lo/NY;

    .line 218
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lo/NY;

    invoke-interface {v0, p3}, Lo/NY;->ʼ(I)Lo/NY;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    invoke-interface {v0, v4}, Lo/NY;->ʼ(I)Lo/NY;
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 200
    :goto_1
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lo/NY;

    invoke-interface {v3, v0}, Lo/NY;->ʻ(I)Lo/NY;
    ...
    invoke-interface {v0, v3}, Lo/NY;->ʼ(I)Lo/NY;
