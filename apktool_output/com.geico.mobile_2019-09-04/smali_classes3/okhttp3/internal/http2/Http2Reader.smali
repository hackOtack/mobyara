...
.method constructor <init>(Lo/NV;Z)V
    ...
    .line 71
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lo/NV;
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lo/NV;

    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lo/NV;)V
    ...
    invoke-direct {v0, v1, v2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(ILo/On;)V
...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lo/NV;
    ...
    .line 214
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lo/NV;

    invoke-interface {p1, v2, p4, v3, v1}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILo/NV;I)V
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {v0, v4, v5}, Lo/NV;->ॱ(J)Lo/NU;

    move-result-object v0

    .line 330
    :cond_3
    invoke-interface {p1, v1, v3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lo/NU;)V
...
.method static readMedium(Lo/NV;)I
    .locals 2

    .prologue
    .line 399
    invoke-interface {p0}, Lo/NV;->ᐝ()B
...
.method private readPing(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 309
    :cond_1
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lo/NV;

    invoke-interface {v2}, Lo/NV;->ʻ()I
...
.method private readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 258
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lo/NV;

    invoke-interface {v4}, Lo/NV;->ʻ()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v2, v4, v5}, Lo/NV;->ˊ(J)V
    :try_end_0
    ...
    invoke-static {v2}, Lokhttp3/internal/http2/Http2Reader;->readMedium(Lo/NV;)I
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {v0, v2, v3}, Lo/NV;->ॱ(J)Lo/NU;
