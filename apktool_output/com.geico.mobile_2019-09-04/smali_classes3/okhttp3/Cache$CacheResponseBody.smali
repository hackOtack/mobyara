...
# instance fields
.field private final bodySource:Lo/NV;
...
.method constructor <init>(Lokhttp3/internal/cache/DiskLruCache$Snapshot;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;->getSource(I)Lo/On;
    ...
    invoke-direct {v1, p0, v0, p1}, Lokhttp3/Cache$CacheResponseBody$1;-><init>(Lokhttp3/Cache$CacheResponseBody;Lo/On;Lokhttp3/internal/cache/DiskLruCache$Snapshot;)V

    invoke-static {v1}, Lo/Oe;->ॱ(Lo/On;)Lo/NV;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/Cache$CacheResponseBody;->bodySource:Lo/NV;
...
.method public source()Lo/NV;
    ...
    .prologue
    .line 767
    iget-object v0, p0, Lokhttp3/Cache$CacheResponseBody;->bodySource:Lo/NV;
