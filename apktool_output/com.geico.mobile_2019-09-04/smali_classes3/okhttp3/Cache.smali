...
.method static readInt(Lo/NV;)I
    .locals 6

    .prologue
    .line 722
    :try_start_0
    invoke-interface {p0}, Lo/NV;->ॱˊ()J

    move-result-wide v0

    .line 723
    invoke-interface {p0}, Lo/NV;->ˋॱ()Ljava/lang/String;
...
.method final get(Lokhttp3/Request;)Lokhttp3/Response;
    ...
    invoke-virtual {v1, v3}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;->getSource(I)Lo/On;

    move-result-object v3

    invoke-direct {v2, v3}, Lokhttp3/Cache$Entry;-><init>(Lo/On;)V
    :try_end_1
