...
# instance fields
.field private final boundary:Lo/NU;
...
.method constructor <init>(Lo/NU;Lokhttp3/MediaType;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 75
    iput-object p1, p0, Lokhttp3/MultipartBody;->boundary:Lo/NU;
    ...
    invoke-virtual {p1}, Lo/NU;->ˋ()Ljava/lang/String;
...
.method private writeOrCountBytes(Lo/NY;Z)J
    ...
    invoke-interface {p1, v0}, Lo/NY;->ˏ([B)Lo/NY;

    .line 138
    iget-object v0, p0, Lokhttp3/MultipartBody;->boundary:Lo/NU;
    ...
    invoke-interface {p1, v9}, Lo/NY;->ˊ(Ljava/lang/String;)Lo/NY;
    ...
    .line 144
    invoke-interface {v9, v10}, Lo/NY;->ˏ([B)Lo/NY;
    ...
    invoke-interface {v9, v10}, Lo/NY;->ˊ(Ljava/lang/String;)Lo/NY;
    ...
    invoke-interface {p1, v6}, Lo/NY;->ˊ(Ljava/lang/String;)Lo/NY;
    ...
    invoke-interface {v6, v0}, Lo/NY;->ˊ(Ljava/lang/String;)Lo/NY;
    ...
    .line 154
    invoke-interface {v0, v6}, Lo/NY;->ˏ([B)Lo/NY;
    ...
    .line 160
    invoke-interface {v0, v8, v9}, Lo/NY;->ॱˊ(J)Lo/NY;
    ...
    invoke-virtual {v1, v2, v3}, Lo/NX;->ʽ(J)V
    :try_end_0
    ...
    .line 173
    :cond_5
    invoke-virtual {v7, p1}, Lokhttp3/RequestBody;->writeTo(Lo/NY;)V
...
.method public final contentLength()J
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lo/NY;Z)J
...
.method public final writeTo(Lo/NY;)V
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lo/NY;Z)J
