...
# instance fields
.field private ʻ:Landroid/widget/RemoteViews;
...
.field private final ˋ:Landroid/app/Notification$Builder;

.field private ˎ:Landroid/widget/RemoteViews;

.field private final ˏ:Lo/Ґ$ı;
...
# direct methods
.method constructor <init>(Lo/Ґ$ı;)V
    .locals 10
    ...
    iput-object v0, p0, Lo/ԧ;->ˊ:Ljava/util/List;
    ...
    iput-object v0, p0, Lo/ԧ;->ʼ:Landroid/os/Bundle;

    .line 63
    iput-object p1, p0, Lo/ԧ;->ˏ:Lo/Ґ$ı;
    ...
    iget-object v3, p1, Lo/Ґ$ı;->ˎ:Landroid/content/Context;

    iget-object v4, p1, Lo/Ґ$ı;->ˋˋ:Ljava/lang/String;

    invoke-direct {v0, v3, v4}, Landroid/app/Notification$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lo/ԧ;->ˋ:Landroid/app/Notification$Builder;

    .line 69
    :goto_0
    iget-object v3, p1, Lo/Ґ$ı;->ˎˏ:Landroid/app/Notification;

    .line 70
    iget-object v0, p0, Lo/ԧ;->ˋ:Landroid/app/Notification$Builder;
    ...
    iget-object v5, p1, Lo/Ґ$ı;->ʻ:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Lo/Ґ$ı;->ˋ:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Lo/Ґ$ı;->ˊ:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Lo/Ґ$ı;->ʼ:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Lo/Ґ$ı;->ʽ:Landroid/app/PendingIntent;
    ...
    iget-object v5, p1, Lo/Ґ$ı;->ᐝ:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lo/Ґ$ı;->ॱॱ:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Lo/Ґ$ı;->ᐝॱ:I

    iget v5, p1, Lo/Ґ$ı;->ॱˋ:I

    iget-boolean v6, p1, Lo/Ґ$ı;->ʻॱ:Z
    ...
    iget-object v4, p1, Lo/Ґ$ı;->ॱˎ:Ljava/lang/CharSequence;
    ...
    iget-boolean v4, p1, Lo/Ґ$ı;->ˏॱ:Z
    ...
    .line 99
    invoke-direct {p0, v0}, Lo/ԧ;->ˎ(Lo/Ґ$if;)V
    ...
    .line 102
    :cond_6
    iget-object v0, p1, Lo/Ґ$ı;->ˊˋ:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    .line 103
    iget-object v0, p0, Lo/ԧ;->ʼ:Landroid/os/Bundle;

    iget-object v4, p1, Lo/Ґ$ı;->ˊˋ:Landroid/os/Bundle;
    ...
    .line 106
    iget-boolean v0, p1, Lo/Ґ$ı;->ʽॱ:Z
    ...
    .line 109
    :cond_8
    iget-object v0, p1, Lo/Ґ$ı;->ˈ:Ljava/lang/String;
    ...
    iget-object v5, p1, Lo/Ґ$ı;->ˈ:Ljava/lang/String;

    invoke-virtual {v0, v4, v5}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    .line 111
    iget-boolean v0, p1, Lo/Ґ$ı;->ʾ:Z
    ...
    :cond_9
    :goto_6
    iget-object v0, p1, Lo/Ґ$ı;->ʿ:Ljava/lang/String;
    ...
    iget-object v4, p1, Lo/Ґ$ı;->ʿ:Ljava/lang/String;

    invoke-virtual {v0, v1, v4}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    .line 123
    :cond_a
    iget-object v0, p1, Lo/Ґ$ı;->ˍ:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lo/ԧ;->ॱ:Landroid/widget/RemoteViews;

    .line 124
    iget-object v0, p1, Lo/Ґ$ı;->ˎˎ:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lo/ԧ;->ˎ:Landroid/widget/RemoteViews;
    ...
    .line 130
    iget-object v0, p1, Lo/Ґ$ı;->ـ:Ljava/util/ArrayList;
    ...
    .line 131
    iget-object v1, p0, Lo/ԧ;->ʼ:Landroid/os/Bundle;

    const-string v4, "android.people"

    iget-object v0, p1, Lo/Ґ$ı;->ـ:Ljava/util/ArrayList;

    iget-object v5, p1, Lo/Ґ$ı;->ـ:Ljava/util/ArrayList;
    ...
    iget-object v1, p1, Lo/Ґ$ı;->ˋˊ:Ljava/lang/String;

    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setCategory(Ljava/lang/String;)Landroid/app/Notification$Builder;

    move-result-object v0

    iget v1, p1, Lo/Ґ$ı;->ˊᐝ:I
    ...
    iget-object v1, p1, Lo/Ґ$ı;->ˋᐝ:Landroid/app/Notification;
    ...
    .line 152
    iget-object v3, p0, Lo/ԧ;->ˋ:Landroid/app/Notification$Builder;
    ...
    .line 154
    :cond_f
    iget-object v0, p1, Lo/Ґ$ı;->ˌ:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lo/ԧ;->ʻ:Landroid/widget/RemoteViews;

    .line 156
    iget-object v0, p1, Lo/Ґ$ı;->ॱ:Ljava/util/ArrayList;
    ...
    iget-object v1, p1, Lo/Ґ$ı;->ˊˋ:Landroid/os/Bundle;

    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setExtras(Landroid/os/Bundle;)Landroid/app/Notification$Builder;

    move-result-object v0

    iget-object v1, p1, Lo/Ґ$ı;->ॱᐝ:[Ljava/lang/CharSequence;
    ...
    iget-object v1, p1, Lo/Ґ$ı;->ˍ:Landroid/widget/RemoteViews;
    ...
    iget-object v1, p1, Lo/Ґ$ı;->ˎˎ:Landroid/widget/RemoteViews;
    ...
    iget-object v1, p1, Lo/Ґ$ı;->ˌ:Landroid/widget/RemoteViews;
    ...
    iget v1, p1, Lo/Ґ$ı;->ˑ:I

    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setBadgeIconType(I)Landroid/app/Notification$Builder;

    move-result-object v0

    iget-object v1, p1, Lo/Ґ$ı;->ˏˎ:Ljava/lang/String;
    ...
    iget v1, p1, Lo/Ґ$ı;->ͺॱ:I

    .line 196
    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setGroupAlertBehavior(I)Landroid/app/Notification$Builder;

    .line 197
    iget-boolean v0, p1, Lo/Ґ$ı;->ˉ:Z
...
.method private ˋ(Landroid/app/Notification;)V
    .locals 1
...
.method private ˎ(Lo/Ґ$if;)V
    ...
    .line 283
    invoke-virtual {p1}, Lo/Ґ$if;->ॱॱ()Z
    ...
    .line 287
    iget-object v0, p0, Lo/ԧ;->ˊ:Ljava/util/List;

    iget-object v1, p0, Lo/ԧ;->ˋ:Landroid/app/Notification$Builder;

    .line 288
    invoke-static {v1, p1}, Lo/ıі;->ॱ(Landroid/app/Notification$Builder;Lo/Ґ$if;)Landroid/os/Bundle;
...
# virtual methods
.method public ˋ()Landroid/app/Notification$Builder;
    .locals 1
...
.method protected ˎ()Landroid/app/Notification;
    ...
    .line 303
    invoke-direct {p0, v0}, Lo/ԧ;->ˋ(Landroid/app/Notification;)V
    ...
    .line 317
    iget-object v1, p0, Lo/ԧ;->ॱ:Landroid/widget/RemoteViews;
    ...
    .line 320
    :cond_4
    iget-object v1, p0, Lo/ԧ;->ˎ:Landroid/widget/RemoteViews;
    ...
    .line 323
    :cond_5
    iget-object v1, p0, Lo/ԧ;->ʻ:Landroid/widget/RemoteViews;
    ...
    .line 370
    invoke-static {v0}, Lo/ıі;->ॱ(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    .line 389
    invoke-static {v1}, Lo/Ґ;->ˏ(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    .line 404
    :cond_12
    iget-object v0, p0, Lo/ԧ;->ॱ:Landroid/widget/RemoteViews;
    ...
    .line 407
    :cond_13
    iget-object v0, p0, Lo/ԧ;->ˎ:Landroid/widget/RemoteViews;
...
.method public ˏ()Landroid/app/Notification;
    ...
    .line 216
    iget-object v0, p0, Lo/ԧ;->ˏ:Lo/Ґ$ı;

    iget-object v1, v0, Lo/Ґ$ı;->ॱˊ:Lo/Ґ$Ι;

    .line 217
    if-eqz v1, :cond_0

    .line 218
    invoke-virtual {v1, p0}, Lo/Ґ$Ι;->ˊ(Lo/Ү;)V
    ...
    .line 222
    invoke-virtual {v1, p0}, Lo/Ґ$Ι;->ˎ(Lo/Ү;)Landroid/widget/RemoteViews;

    move-result-object v0

    .line 224
    :goto_0
    invoke-virtual {p0}, Lo/ԧ;->ˎ()Landroid/app/Notification;
    ...
    .line 231
    invoke-virtual {v1, p0}, Lo/Ґ$Ι;->ॱ(Lo/Ү;)Landroid/widget/RemoteViews;
    ...
    iget-object v0, v0, Lo/Ґ$ı;->ॱˊ:Lo/Ґ$Ι;

    .line 238
    invoke-virtual {v0, p0}, Lo/Ґ$Ι;->ˏ(Lo/Ү;)Landroid/widget/RemoteViews;
    ...
    .line 245
    invoke-static {v2}, Lo/Ґ;->ˏ(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    .line 247
    invoke-virtual {v1, v0}, Lo/Ґ$Ι;->ˋ(Landroid/os/Bundle;)V
    ...
    iget-object v0, v0, Lo/Ґ$ı;->ˍ:Landroid/widget/RemoteViews;
