.class public Lcom/scvngr/levelup/app/bmo;
.super Ljava/lang/Object;


# static fields
.field private static final a:Ljava/lang/String; = "bmo"
...
.field private static c:Lcom/scvngr/levelup/app/bmp;
...
.method public static a(Landroid/content/Context;)Lcom/scvngr/levelup/app/bmp;
    .locals 3
    ...
    sget-object v0, Lcom/scvngr/levelup/app/bmo;->c:Lcom/scvngr/levelup/app/bmp;

    if-eqz v0, :cond_0

    sget-object p0, Lcom/scvngr/levelup/app/bmo;->c:Lcom/scvngr/levelup/app/bmp;
    ...
    invoke-direct {p0, v0}, Lcom/scvngr/levelup/app/apn;-><init>(I)V

    throw p0

    :cond_1
    invoke-static {p0}, Lcom/scvngr/levelup/app/bmo;->b(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-static {v0, v1}, Lcom/scvngr/levelup/app/bmo;->a(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Object;
    ...
    instance-of v2, v1, Lcom/scvngr/levelup/app/bmp;

    if-eqz v2, :cond_3

    move-object v0, v1

    check-cast v0, Lcom/scvngr/levelup/app/bmp;

    goto :goto_0

    :cond_3
    new-instance v1, Lcom/scvngr/levelup/app/bmq;

    invoke-direct {v1, v0}, Lcom/scvngr/levelup/app/bmq;-><init>(Landroid/os/IBinder;)V

    move-object v0, v1

    :goto_0
    sput-object v0, Lcom/scvngr/levelup/app/bmo;->c:Lcom/scvngr/levelup/app/bmp;
    ...
    invoke-interface {v0, p0, v1}, Lcom/scvngr/levelup/app/bmp;->a(Lcom/scvngr/levelup/app/axz;I)V
    :try_end_0
...
.method private static a(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Lcom/scvngr/levelup/app/bmo;->a(Ljava/lang/Class;)Ljava/lang/Object;
...
.method private static b(Landroid/content/Context;)Landroid/content/Context;
    ...
    sget-object v0, Lcom/scvngr/levelup/app/bmo;->b:Landroid/content/Context;

    if-eqz v0, :cond_0

    sget-object p0, Lcom/scvngr/levelup/app/bmo;->b:Landroid/content/Context;

    return-object p0

    :cond_0
    invoke-static {p0}, Lcom/scvngr/levelup/app/bmo;->c(Landroid/content/Context;)Landroid/content/Context;

    move-result-object p0

    sput-object p0, Lcom/scvngr/levelup/app/bmo;->b:Landroid/content/Context;
...
.method private static c(Landroid/content/Context;)Landroid/content/Context;
    ...
    .line 1000
    iget-object v0, v0, Lcom/google/android/gms/dynamite/DynamiteModule;->g:Landroid/content/Context;
    :try_end_0
