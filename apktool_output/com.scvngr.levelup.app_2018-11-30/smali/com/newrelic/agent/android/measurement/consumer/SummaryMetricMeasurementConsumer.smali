...
.method private summarizeActivityNetworkMetrics(Lcom/newrelic/agent/android/tracing/ActivityTrace;)V
    ...
    .line 118
    iget-object v5, p1, Lcom/newrelic/agent/android/tracing/ActivityTrace;->networkCountMetric:Lcom/newrelic/agent/android/metric/Metric;
    ...
    invoke-virtual {v6, v5}, Lcom/newrelic/agent/android/metric/Metric;->setName(Ljava/lang/String;)V

    .line 120
    iget-object v5, p1, Lcom/newrelic/agent/android/tracing/ActivityTrace;->networkCountMetric:Lcom/newrelic/agent/android/metric/Metric;

    invoke-virtual {v5, v1, v2}, Lcom/newrelic/agent/android/metric/Metric;->setCount(J)V
    ...
    invoke-virtual {v5, v6}, Lcom/newrelic/agent/android/metric/Metric;->setMinFieldValue(Ljava/lang/Double;)V
    ...
    invoke-virtual {v5, v6}, Lcom/newrelic/agent/android/metric/Metric;->setMaxFieldValue(Ljava/lang/Double;)V

    .line 123
    iget-object v5, p1, Lcom/newrelic/agent/android/tracing/ActivityTrace;->networkCountMetric:Lcom/newrelic/agent/android/metric/Metric;

    invoke-static {v5}, Lcom/newrelic/agent/android/harvest/Harvest;->addMetric(Lcom/newrelic/agent/android/metric/Metric;)V

    .line 126
    :cond_0
    iget-object v5, p1, Lcom/newrelic/agent/android/tracing/ActivityTrace;->networkTimeMetric:Lcom/newrelic/agent/android/metric/Metric;

    invoke-virtual {v5}, Lcom/newrelic/agent/android/metric/Metric;->getCount()J
    ...
    .line 128
    iget-object v4, p1, Lcom/newrelic/agent/android/tracing/ActivityTrace;->networkTimeMetric:Lcom/newrelic/agent/android/metric/Metric;
    ...
    invoke-virtual {v4, v0}, Lcom/newrelic/agent/android/metric/Metric;->setName(Ljava/lang/String;)V
